    ...
    return (
        <div className={` h-screen overflow-hidden ${className ?? ""}`}>
            <div className="flex flex-col md:flex-row  h-full">
                {/* Left panel */}
                <div
                    className="flex-1 relative bg-[url('/backgroundImg.jpg')] bg-center bg-cover md:bg-cover bg-no-repeat flex flex-col"
                >
                    {/* Top logo */}
                    <img
                    ...
                    {/* Centered content */}
                    <div className="flex-1 flex flex-col relative  md:mt-[10vh] top-1/5 md:top-1/6 justify-center px-4 text-white gap-4 md:w-[840px]">
